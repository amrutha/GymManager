...
public class GymDetailsView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		Section sctnNewSection = formToolkit.createSection(composite_1, Section.TWISTIE | Section.TITLE_BAR);
		...
		{
			Button btnName = new Button(composite_2, SWT.RADIO);
			btnName.setSelection(true);
			formToolkit.adapt(btnName, true, true);
			btnName.setText("Name ");
		}
		{
			Button btnMobileNo = new Button(composite_2, SWT.RADIO);
			formToolkit.adapt(btnMobileNo, true, true);
			btnMobileNo.setText("Mobile No");
		}
		
		txtSearchHere = new Text(composite_2, SWT.BORDER);
		txtSearchHere.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		formToolkit.adapt(txtSearchHere, true, true);
		{
			Section sctnGymData = formToolkit.createSection(composite_1, Section.TITLE_BAR);
			sctnGymData.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));
			...
			sctnGymData.setExpanded(true);
			{
				...
				composite.setLayout(new GridLayout(1, false));
				{
					...
					{
						TableViewerColumn tableViewerColumn = new TableViewerColumn(tableViewer, SWT.NONE);
						TableColumn tblclmnMemberName = tableViewerColumn.getColumn();
						tblclmnMemberName.setWidth(123);
						tblclmnMemberName.setText("Member Name");
					}
					{
						TableViewerColumn tableViewerColumn = new TableViewerColumn(tableViewer, SWT.NONE);
						TableColumn tblclmnMobileNo = tableViewerColumn.getColumn();
