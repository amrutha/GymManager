...
public class MemberDetailsView extends ViewPart implements ISelectionListener {
	...
	public void createPartControl(Composite parent) {
		...
		{
			Section sctnMemberDetails = formToolkit.createSection(composite, Section.TWISTIE | Section.TITLE_BAR);
			sctnMemberDetails.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1));
			formToolkit.paintBordersFor(sctnMemberDetails);
			sctnMemberDetails.setText("Member Details ");
			sctnMemberDetails.setExpanded(true);
			{
				Composite composite_1 = new Composite(sctnMemberDetails, SWT.NONE);
				formToolkit.adapt(composite_1);
				formToolkit.paintBordersFor(composite_1);
				sctnMemberDetails.setClient(composite_1);
				composite_1.setLayout(new GridLayout(3, false));
				{
					Label lblMemberId = formToolkit.createLabel(composite_1, "Member Id : ", SWT.NONE);
					lblMemberId.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
				}
				{
					txtId = formToolkit.createText(composite_1, "New Text", SWT.NONE);
					txtId.setText("");
				...
				{
					Button btnPhotoUnavailable = new Button(composite_1, SWT.NONE);
					GridData gd_btnPhotoUnavailable = new GridData(SWT.FILL, SWT.FILL, false, false, 1, 5);
					...
					btnPhotoUnavailable.addSelectionListener(new SelectionAdapter() {
						@Override
				...
				{
					Label lblNewLabel_1 = formToolkit.createLabel(composite_1, "Name : ", SWT.NONE);
				...
				{
					Label lblMobileNo = formToolkit.createLabel(composite_1, "Mobile No : ", SWT.NONE);
				...
				lblStatus.setText("BloodGroup : ");
				{
					...
					txtBloodgroup.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		...
		{
			Section sctnPlanDet = formToolkit.createSection(composite, Section.TWISTIE | Section.TITLE_BAR);
			sctnPlanDet.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));
